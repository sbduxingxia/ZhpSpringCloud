...
import com.zhp.springcloud.server.api.dto.page.ReqPage;
...
public class MybatisPageInterceptor implements Interceptor {
    private static final Logger logger = LoggerFactory.getLogger(MybatisPageInterceptor.class.getName());
...
//            if (paramMap.containsKey("PageBean")) {
//                model = (PageBean)paramMap.get("PageBean");
//            }
//        }

        if (parameterObject instanceof ReqPage) {
            model = (ReqPage) parameterObject;
        } else {
    ...
    private void queryTotal(MappedStatement mappedStatement, String replaceSql, Object parameterObject, BoundSql boundSql,ReqPage model) throws Exception{
